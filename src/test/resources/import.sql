...
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Bluza Sport', 'Bluza sportowa z kapturem', 129.99, 30, 2, 'https://example.com/bluza.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true);
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Kurtka Zimowa', 'Ciepła kurtka na zimę', 499.99, 12, 2, 'https://example.com/kurtka.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true);
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Krzesło Drewniane', 'Wygodne krzesło do domu', 299.99, 15, 3, 'https://example.com/krzeslo.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true);
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Stół Szklany', 'Elegancki stół do salonu', 899.99, 8, 3, 'https://example.com/stol.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true);
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Lampa Stołowa', 'Nowoczesna lampa', 199.99, 20, 3, 'https://example.com/lampa.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true);
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Piłka Nożna', 'Profesjonalna piłka nożna', 79.99, 20, 4, 'https://example.com/pilka.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true);
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Rękawice Bokserskie', 'Skórzane rękawice', 149.99, 15, 4, 'https://example.com/rękawice.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), false);
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Mata Joga', 'Antypoślizgowa mata', 99.99, 25, 4, 'https://example.com/mata.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true);
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Książka Java', 'Podręcznik programowania w Javie', 99.99, 40, 5, 'https://example.com/java.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true);
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Książka Python', 'Poradnik Pythona', 89.99, 35, 5, 'https://example.com/python.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true);
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Książka C++', 'Podstawy C++', 79.99, 30, 5, 'https://example.com/cpp.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), false);
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Słownik Angielski', 'Słownik językowy', 49.99, 60, 5, 'https://example.com/slownik.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true);
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Smartwatch', 'Monitor aktywności', 599.99, 15, 1, 'https://example.com/smartwatch.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), false);
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Słuchawki', 'Bezprzewodowe słuchawki', 299.99, 25, 1, 'https://example.com/sluchawki.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true);
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Spodnie Jeans', 'Męskie spodnie', 149.99, 40, 2, 'https://example.com/jeans.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true);
INSERT INTO products (version, name, description, price, stock_quantity, category_id, image_url, created_at, updated_at, active) VALUES (0, 'Kurtka Przejściowa', 'Lekka kurtka na wiosnę', 249.99, 20, 2, 'https://example.com/kurtka_wiosna.jpg', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), true);
